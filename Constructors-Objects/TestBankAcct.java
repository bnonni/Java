...
public class TestBankAcct {
  public static void main(String[] arg) {
    try {
      ...
      bryan.setAccount_no("abc12345");
      System.out.println("1. john's account is " + bryan.getAccount_no());
      bryan.setAccount_balance(10);
      System.out.println("2. john's balance is $" + bryan.getAccount_balance());
      System.out.println("3. john's charge is $" + bryan.computeCharge());
